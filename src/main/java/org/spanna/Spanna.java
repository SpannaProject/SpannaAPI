...
/**
 * Represents the Spanna core, for version and Server singleton handling
 */
public final class Spanna {
    ...
    public static void setServer(Server server) {
        if (Spanna.server != null) {
            throw new UnsupportedOperationException("[ERROR] Cannot redefine the server!");
        }

        Spanna.server = server;
        server.getLogger().info("[SERVER] This Minecraft server is running " + getName() + " version " + getVersion() + " (Implementing API version, Injecting Byte Code " + getSpannaVersion() + ")");
    ...
    /**
     * @see Server#getSpannaVersion()
     */
    public static String getSpannaVersion() {
        return server.getSpannaVersion();
    }
    ...
    /**
     * @see Server#getComponentCommand(String name)
     */
    public static ComponentCommand getComponentCommand(String name) {
        return server.getComponentCommand(name);
    }
