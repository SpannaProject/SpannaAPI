...
import org.spanna.help.HelpTopicComparator;
import org.spanna.help.IndexHelpTopic;
import org.spanna.util.ChatPaginator;
...
public class HelpCommand extends VanillaCommand {
    public HelpCommand() {
        ...
        this.setPermission("spanna.command.help");
    }
    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        HelpMap helpMap = Spanna.getServer().getHelpMap();
        ...
        if (topic == null || !topic.canSee(sender)) {
            sender.sendMessage(ChatColor.RED + "[ERROR] No help for " + command);
            return true;
        }
    ...
    public List<String> tabComplete(CommandSender sender, String alias, String[] args) {
        ...
        if (args.length == 1) {
            ...
            for (HelpTopic topic : Spanna.getServer().getHelpMap().getHelpTopics()) {
