...
public class MapFont {
    ...
    public void setChar(char ch, CharacterSprite sprite) {
        if (!malleable) {
            throw new IllegalStateException("[ERROR] This font is not malleable");
        }
    ...
    public int getWidth(String text) {
        if (!isValid(text)) {
            throw new IllegalArgumentException("[ERROR] Text contains invalid characters");
        }
    ...
    public static class CharacterSprite {
        ...
        public CharacterSprite(int width, int height, boolean[] data) {
            ...
            if (data.length != width * height) {
                throw new IllegalArgumentException("[ERROR] Size of data does not match dimensions");
            }
        }
