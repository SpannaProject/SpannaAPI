 ...
 * SpannaObjectInputStream}.
 * <p>
 * Behavior of implementations extending this class is not guaranteed across
 * future versions.
 */
public class SpannaObjectInputStream extends ObjectInputStream {
     ...
     */
    protected SpannaObjectInputStream() throws IOException, SecurityException {
        super();
     ...
     */
    public SpannaObjectInputStream(InputStream in) throws IOException {
        super(in);
        super.enableResolveObject(true);
    }
    ...
    protected Object resolveObject(Object obj) throws IOException {
        if (obj instanceof Wrapper) {
            try {
                ...
                throw newIOException("[WARNING] Failed to deserialize object!", ex);
            }
        }
