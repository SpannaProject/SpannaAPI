 ...
 * future versions.
 */
public class SpannaObjectOutputStream extends ObjectOutputStream {
     ...
     */
    protected SpannaObjectOutputStream() throws IOException, SecurityException {
        super();
     ...
     */
    public SpannaObjectOutputStream(OutputStream out) throws IOException {
        super(out);
        super.enableReplaceObject(true);
    }
