...
import static org.spanna.util.NumberConversions.*;
...
public class BlockIterator implements Iterator<Block> {
    ...
    public BlockIterator(World world, Vector start, Vector direction, double yOffset, int maxDistance) {
        ...
        if (!startBlockFound) {
            throw new IllegalStateException("[ERROR] Start block missed in BlockIterator");
        }
    ...
    public void remove() {
        throw new UnsupportedOperationException("[SERVER] [BlockIterator] doesn't support block removal");
    }
