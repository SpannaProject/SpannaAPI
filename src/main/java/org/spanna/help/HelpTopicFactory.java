 ...
 * the way all the commands in your plugin display in the help. If your component
 * implements a complex permissions system, a custom help topic may also be
 * appropriate.
 * <p>
 * To automatically bind your component's commands to your custom HelpTopic
 ...
 * org.spanna.command.ComponentCommand}, then the type of the command's executor
