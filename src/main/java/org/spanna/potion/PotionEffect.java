...
import org.spanna.configuration.serialization.SerializableAs;
...
public class PotionEffect implements ConfigurationSerializable {
    ...
    private static PotionEffectType getEffectType(Map<?,?> map) {
        ...
        throw new NoSuchElementException(["[ERROR]" + map + " does not contain " + TYPE);
    }
    ...
    private static int getInt(Map<?,?> map, Object key) {
        ...
        throw new NoSuchElementException("[ERROR]" + map + " does not contain " + key);
    }
