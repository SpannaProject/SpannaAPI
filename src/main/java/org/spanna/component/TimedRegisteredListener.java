...
public class TimedRegisteredListener extends RegisteredListener {
    ...
    public TimedRegisteredListener(final Listener componentListener, final EventExecutor eventExecutor, final EventPriority eventPriority, final Component registeredComponent, final boolean listenCancelled) {
        super(componentListener, eventExecutor, eventPriority, registeredComponent, listenCancelled);
    }
