...
import org.spanna.entity.CreatureType;
import org.spanna.entity.Egg;
...
public class PlayerEggThrowEvent extends PlayerEvent {
    ...
    public void setHatchingType(EntityType hatchType) {
        if(!hatchType.isSpawnable()) throw new IllegalArgumentException("[ERROR] Can't spawn that entity type from an egg!");
