 ...
 * {@link SpannaScheduler#runTask(Component, Runnable)}, which will run the task
 ...
 * Alternatively, scheduling a task using {@link SpannaScheduler#runTask(
 * Component, Runnable)}, which would execute the task on the next tick, would
 * work as well.
 */
