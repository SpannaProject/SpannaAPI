package org.spanna.generator;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;
import org.component.Location;
import org.component.Material;
import org.component.World;
import org.component.block.Biome;
import org.component.block.Block;
...
public abstract class ChunkGenerator {
    ...
    public byte[] generate(World world, Random random, int x, int z) {
        throw new UnsupportedOperationException("[ERROR] Custom generator is missing required methods: generate(), generateBlockSections() and generateExtBlockSections()");
    }
