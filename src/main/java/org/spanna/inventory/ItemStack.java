...
public class ItemStack implements Cloneable, ConfigurationSerializable {
    ...
    public ItemStack(final ItemStack stack) throws IllegalArgumentException {
        Validate.notNull(stack, "[ERROR] Cannot copy null stack");
    ...
    public void setType(Material type) {
        Validate.notNull(type, "[ERROR] Material cannot be null");
    ...
    public void setTypeId(int type) {
        this.type = type;
        if (this.meta != null) {
            this.meta = Spanna.getItemFactory().asMetaFor(meta, getType0());
        }
        createData((byte) 0);
    }
    ...
    public void setData(MaterialData data) {
        ...
        if (data == null || mat == null || mat.getData() == null) {
            ...
            if ((data.getClass() == mat.getData()) || (data.getClass() == MaterialData.class)) {
                ...
                throw new IllegalArgumentException("[ERROR] Provided data is not of type " + mat.getData().getName() + ", found " + data.getClass().getName());
            }
        }
    }
    ...
    public void addEnchantments(Map<Enchantment, Integer> enchantments) {
        Validate.notNull(enchantments, "[ERROR] Enchantments cannot be null");
    ...
    public void addEnchantment(Enchantment ench, int level) {
        Validate.notNull(ench, "[ERROR] Enchantment cannot be null");
        if ((level < ench.getStartLevel()) || (level > ench.getMaxLevel())) {
            throw new IllegalArgumentException("[ERROR] Enchantment level is either too low or too high (given " + level + ", bounds are " + ench.getStartLevel() + " to " + ench.getMaxLevel() + ")");
        } else if (!ench.canEnchantItem(this)) {
            throw new IllegalArgumentException("[ERROR] Specified enchantment cannot be applied to this itemstack");
        }
    ...
    public void addUnsafeEnchantment(Enchantment ench, int level) {
        (meta == null ? meta = Spanna.getItemFactory().getItemMeta(getType0()) : meta).addEnchant(ench, level, true);
    }
    ...
    public ItemMeta getItemMeta() {
        return this.meta == null ? Spanna.getItemFactory().getItemMeta(getType0()) : this.meta.clone();
    }
    ...
    private boolean setItemMeta0(ItemMeta itemMeta, Material material) {
        ...
        this.meta = Spanna.getItemFactory().asMetaFor(itemMeta, material);
