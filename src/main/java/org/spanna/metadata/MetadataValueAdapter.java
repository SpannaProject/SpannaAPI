...
public abstract class MetadataValueAdapter implements MetadataValue {
    protected final WeakReference<Component> owningComponent;

    protected MetadataValueAdapter(Component owningComponent) {
        Validate.notNull(owningComponent, "owningComponent cannot be null");
        this.owningComponent = new WeakReference<Component>(owningComponent);
    }
