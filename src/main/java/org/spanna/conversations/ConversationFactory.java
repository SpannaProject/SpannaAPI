 ...
 * a component is instantiated and builds a Conversation each time a user
 * initiates a conversation with the component. Each Conversation maintains its
...
public class ConversationFactory {
     ...
     *
     * @param component The component that owns the factory.
     */
    public ConversationFactory(Component component)
    {
    ...
    public ConversationFactory withTimeout(int timeoutSeconds) {
        return withConversationCanceller(new InactivityConversationCanceller(component, timeoutSeconds));
    }
    ...
    public Conversation buildConversation(Conversable forWhom) {
        ...
        if (playerOnlyMessage != null && !(forWhom instanceof Player)) {
            return new Conversation(component, forWhom, new NotPlayerMessagePrompt());
        }
        ...
        Conversation conversation = new Conversation(component, forWhom, firstPrompt, copiedInitialSessionData);
