 ...
 * display the component name or conversation status as the conversation evolves.
 * <p>
...
public class Conversation {
     ...
     *
     * @param component The component that owns this conversation.
     ...
     */
    public Conversation(Component component, Conversable forWhom, Prompt firstPrompt) {
        this(component, forWhom, firstPrompt, new HashMap<Object, Object>());
    }
     ...
     */
    public Conversation(Component component, Conversable forWhom, Prompt firstPrompt, Map<Object, Object> initialSessionData) {
        this.firstPrompt = firstPrompt;
        this.context = new ConversationContext(component, forWhom, initialSessionData);
        this.modal = true;
